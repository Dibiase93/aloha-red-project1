...
!(function(e) {
          ...
          r(n, [
            {
              ...
              value: function(e) {
                e === this.activePlugin
                  ? (e.deactivate(), (this.activePlugin = null))
                  : (this.activePlugin && this.activePlugin.deactivate(),
                    e.activate(),
                    (this.activePlugin = e));
              }
            },
            {
              ...
              value: function(t) {
                ...
                o.experimental.length &&
                  (u = e(
                    ...
                    e(
                      "ul",
                      null,
                      o.experimental.map(function(t) {
                        return e(t, { onClick: n.handlePluginClick.bind(n) });
                      })
                    )
                  ));
                var c = e("ul", { className: "tota11y-plugins" }, l, u),
                  p = function(e) {
                    e.preventDefault(),
                      e.stopPropagation(),
                      s.toggleClass("tota11y-expanded"),
                      s.attr("aria-expanded", s.is(".tota11y-expanded"));
                  },
                  d = e(
                    "button",
                    {
                ...
                (s = e(
                  ...
                  e("div", { className: "tota11y-toolbar-body" }, c),
                  d
                )),
                  t.append(s);
              }
    ...
    !(function(t, n) {
      ...
      function i(e) {
        var t = !!e && "length" in e && e.length,
          n = ue.type(e);
        return "function" === n || ue.isWindow(e)
          ? !1
          : "array" === n ||
              0 === t ||
      ...
      function u(e) {
        var t = {};
        return (
          ue.each(e.match(_e) || [], function(e, n) {
            t[n] = !0;
          }),
          t
        );
      ...
      function c() {
        Q.removeEventListener("DOMContentLoaded", c),
      ...
      function f(e, t, n, r) {
        var a,
          ...
          c = (ue.cssNumber[t] || ("px" !== u && +l)) && Pe.exec(ue.css(e, t));
        if (c && c[3] !== u) {
          (u = u || c[3]), (n = n || []), (c = +l || 1);
            ...
            if ("object" === ue.type(o)) ue.merge(d, o.nodeType ? [o] : o);
              ...
              for (
                i = i || p.appendChild(t.createElement("div")),
                  ...
                  l = Fe[s] || Fe._default,
                  i.innerHTML = l[1] + ue.htmlPrefilter(o) + l[2],
                  c = l[0];
                c--;

              )
                i = i.lastChild;
              ue.merge(d, i.childNodes),
                (i = p.firstChild),
                (i.textContent = "");
            } else d.push(t.createTextNode(o));
        for (p.textContent = "", f = 0; (o = d[f++]); )
          if (r && ue.inArray(o, r) > -1) a && a.push(o);
          else if (
            ((u = ue.contains(o.ownerDocument, o)),
            (i = h(p.appendChild(o), "script")),
            u && g(i),
            n)
          )
            for (c = 0; (o = i[c++]); ) qe.test(o.type || "") && n.push(o);
        return p;
      }
      function b() {
        return !0;
      ...
      function w(e, t) {
        return ue.nodeName(e, "table") &&
          ue.nodeName(11 !== t.nodeType ? t : t.firstChild, "tr")
      ...
      function C(e, t) {
        ...
        if (1 === t.nodeType) {
          if (
            Se.hasData(e) &&
            ((o = Se.access(e)), (i = Se.set(t, o)), (u = o.events))
          ) {
            delete i.handle, (i.events = {});
            for (a in u)
              for (n = 0, r = u[a].length; r > n; n++)
                ue.event.add(t, a, u[a][n]);
          }
          Ne.hasData(e) &&
            ((s = Ne.access(e)), (l = ue.extend({}, s)), Ne.set(t, l));
        }
      }
      function _(e, t) {
      ...
      function T(e, t, n, r) {
        ...
        if (
          g ||
          (p > 1 && "string" == typeof f && !se.checkClone && $e.test(f))
        )
        ...
        if (
          p &&
          ((a = m(t, e[0].ownerDocument, !1, e, r)),
          (o = a.firstChild),
          1 === a.childNodes.length && (a = o),
          o || r)
        ) {
          for (i = ue.map(h(a, "script"), A), s = i.length; p > c; c++)
            (l = a),
              c !== d &&
          ...
          if (s)
            for (
              u = i[i.length - 1].ownerDocument, ue.map(i, E), c = 0;
              s > c;
              c++
            )
              (l = i[c]),
                qe.test(l.type || "") &&
                  ...
                  ue.contains(u, l) &&
                  (l.src
                    ? ue._evalUrl && ue._evalUrl(l.src)
                    : ue.globalEval(l.textContent.replace(Xe, "")));
        }
        return e;
      }
      function R(e, t, n) {
        for (var r, a = t ? ue.filter(t, e) : e, o = 0; null != (r = a[o]); o++)
          n || 1 !== r.nodeType || ue.cleanData(h(r)),
            r.parentNode &&
              (n && ue.contains(r.ownerDocument, r) && g(h(r, "script")),
      ...
      function S(e) {
        ...
        return (
          n ||
            ...
            ("none" !== n && n) ||
              ((Ke = (
                Ke || ue("<iframe frameborder='0' width='0' height='0'/>")
      ...
      function P(e, t, n, r, a) {
        for (
          ...
          "margin" === n && (i += ue.css(e, n + De[o], !0, a)),
            r
              ? ("content" === n && (i -= ue.css(e, "padding" + De[o], !0, a)),
                "margin" !== n &&
                  (i -= ue.css(e, "border" + De[o] + "Width", !0, a)))
              : ((i += ue.css(e, "padding" + De[o], !0, a)),
                "padding" !== n &&
                  (i += ue.css(e, "border" + De[o] + "Width", !0, a)));
        return i;
      }
      function D(e, t, n) {
        var r = !0,
          ...
          o = et(e),
          i = "border-box" === ue.css(e, "boxSizing", !1, o);
        if (0 >= a || null == a) {
          if (
            ((a = N(e, t, o)),
            ...
            return a;
          (r = i && (se.boxSizingReliable() || a === e.style[t])),
            (a = parseFloat(a) || 0);
        }
      ...
      function M(e, t) {
        for (var n, r, a, o = [], i = 0, s = e.length; s > i; i++)
          (r = e[i]),
            r.style &&
              ((o[i] = Se.get(r, "olddisplay")),
              (n = r.style.display),
              t
                ? (o[i] || "none" !== n || (r.style.display = ""),
                  "" === r.style.display &&
                    Me(r) &&
                    (o[i] = Se.access(r, "olddisplay", S(r.nodeName))))
                : ((a = Me(r)),
                  ("none" === n && a) ||
                    Se.set(r, "olddisplay", a ? n : ue.css(r, "display"))));
        for (i = 0; s > i; i++)
          (r = e[i]),
            r.style &&
      ...
      function q(e, t) {
        ...
        for (t = t ? 1 : 0; 4 > r; r += 2 - t)
          (n = De[r]), (a["margin" + n] = a["padding" + n] = e);
      ...
      function W(e, t, n) {
        var r,
          ...
          u = s.promise({
            ...
            opts: ue.extend(
              !0,
              { specialEasing: {}, easing: ue.easing._default },
              n
            ),
          ...
          c = u.props;
        for (U(c, u.opts.specialEasing); i > o; o++)
          if ((r = W.prefilters[o].call(u, e, c, u.opts)))
            return (
              ue.isFunction(r.stop) &&
                (ue._queueHooks(u.elem, u.opts.queue).stop = ue.proxy(
                  r.stop,
                  r
                )),
              r
            ...
            if ("*" === o) o = l;
              ...
              if (((i = u[l + " " + o] || u["* " + o]), !i))
                for (a in u)
                  if (
                    ((s = a.split(" ")),
                    s[1] === o && (i = u[l + " " + s[0]] || u["* " + s[0]]))
                  ) {
                    i === !0
                      ? (i = u[a])
                      : u[a] !== !0 && ((o = s[0]), c.unshift(s[1]));
                    break;
                  }
              if (i !== !0)
                if (i && e["throws"]) t = i(t);
      ...
      (ue.fn = ue.prototype = {
        ...
        (ue.extend = ue.fn.extend = function() {
          ...
          for (
            "boolean" == typeof i && ((u = i), (i = arguments[s] || {}), s++),
              "object" == typeof i || ue.isFunction(i) || (i = {}),
              s === l && ((i = this), s--);
            l > s;
            s++
          )
            if (null != (e = arguments[s]))
              for (t in e)
                (n = i[t]),
                  (r = e[t]),
                  i !== r &&
                    (u && r && (ue.isPlainObject(r) || (a = ue.isArray(r)))
                      ? (a
                          ? ((a = !1), (o = n && ue.isArray(n) ? n : []))
                          : (o = n && ue.isPlainObject(n) ? n : {}),
                        (i[t] = ue.extend(u, o, r)))
                      : void 0 !== r && (i[t] = r));
          return i;
        }),
        ue.extend({
          ...
          isPlainObject: function(e) {
            ...
            if (
              e.constructor &&
              !ie.call(e, "constructor") &&
              !ie.call(e.constructor.prototype || {}, "isPrototypeOf")
            )
              return !1;
            for (t in e);
          ...
          makeArray: function(e, t) {
            ...
            return (
              null != e &&
                (i(Object(e))
                  ? ue.merge(n, "string" == typeof e ? [e] : e)
                  : ne.call(n, e)),
              n
            );
          },
        ...
        "function" == typeof Symbol &&
          (ue.fn[Symbol.iterator] = Z[Symbol.iterator]),
        ue.each(
       ...
       */ (function(e) {
        function t(e, t, n, r) {
          ...
          if (
            !r &&
            ((t ? t.ownerDocument || t : F) !== I && O(t), (t = t || I), P)
          ) {
            if (11 !== g && (u = be.exec(e)))
              if ((a = u[1])) {
                if (9 === g) {
          ...
          return (
            ...
            r(function(r, i, s, l) {
              var u,
                ...
                y = n ? (o || (r ? e : h || a) ? [] : i) : v;
              if ((n && n(v, y, s, l), a))
                for (u = m(y, f), a(u, [], s, l), c = u.length; c--; )
                  (p = u[c]) && (y[f[c]] = !(v[f[c]] = p));
              if (r) {
                if (o || e) {
                  if (o) {
        ...
        function v(e) {
          for (
            ...
            if ((n = A.relative[e[s].type])) c = [f(h(c), n)];
            else {
          ...
          var a = n.length > 0,
            ...
            i = function(r, i, s, l, u) {
              ...
              for (
                ...
                if (o && c) {
                  for (
                    p = 0, i || c.ownerDocument === I || (O(c), (s = !P));
                    (d = e[p++]);
        ...
        (w = t.support = {}),
                      ...
                      return n
                        ...
                        : ((n =
                          ...
                          (!w.sortDetached &&
                            ...
                            ? e === I || (e.ownerDocument === F && H(F, e))
                              ? -1
                              : t === I || (t.ownerDocument === F && H(F, t))
                              ? 1
                              : S
                              ? ee(S, e) - ee(S, t)
                              : 0
          ...
          (t.attr = function(e, t) {
            ...
            var n = A.attrHandle[t.toLowerCase()],
              r =
                n && z.call(A.attrHandle, t.toLowerCase())
                  ? n(e, t, !P)
                  : void 0;
            return void 0 !== r
              ? r
        ...
        for (x in {
          ...
          A.pseudos[x] = s(x);
        for (x in { submit: !0, reset: !0 }) A.pseudos[x] = l(x);
        return (
          ...
          (_ = t.tokenize = function(e, n) {
            ...
            for (s = e, l = [], u = A.preFilter; s; ) {
              (r && !(a = le.exec(s))) ||
                ...
                (a = ue.exec(s)) &&
                  ((r = a.shift()),
                  o.push({ value: r, type: a[0].replace(se, " ") }),
                  (s = s.slice(r.length)));
              for (i in A.filter)
                !(a = fe[i].exec(s)) ||
                  (u[i] && !(a = u[i](a))) ||
          ...
          (R = t.select = function(e, t, n, r) {
            ...
            if (((n = n || []), 1 === p.length)) {
              if (
                ...
                if (
                  ((t = (A.find.ID(i.matches[0].replace(xe, we), t) || [])[0]),
                  !t)
                )
                  return n;
              ...
              for (
                a = fe.needsContext.test(e) ? 0 : o.length;
                a-- && ((i = o[a]), !A.relative[(s = i.type)]);

              )
                if (
                  (l = A.find[s]) &&
                  (r = l(
                    i.matches[0].replace(xe, we),
                    (ve.test(o[0].type) && c(t.parentNode)) || t
                  ))
                ) {
                  if ((o.splice(a, 1), (e = r.length && d(o)), !e))
      ...
      (ue.filter = function(e, t, n) {
        ...
        ue.fn.extend({
          find: function(e) {
            ...
            return (
              (r = this.pushStack(n > 1 ? ue.unique(r) : r)),
          ...
          is: function(e) {
            return !!s(
              this,
              "string" == typeof e && be.test(e) ? ue(e) : e || [],
              !1
            ).length;
          }
        });
          ...
          if (((n = n || xe), "string" == typeof e)) {
            ...
            if (r[1]) {
              if (
                ...
                ve.test(r[1]) && ue.isPlainObject(t))
              )
                for (r in t)
        ...
        ue.each(
          ...
          function(e, t) {
            ue.fn[e] = function(n, r) {
              ...
              return (
                "Until" !== e.slice(-5) && (r = n),
                r && "string" == typeof r && (a = ue.filter(r, a)),
                this.length > 1 &&
                  (Ce[e] || ue.uniqueSort(a), Ee.test(e) && a.reverse()),
                this.pushStack(a)
              );
            };
          }
      ...
      (ue.Callbacks = function(e) {
        ...
        var t,
          ...
          s = -1,
          l = function() {
            for (a = e.once, r = t = !0; i.length; s = -1)
                  ...
                  (function r(t) {
                    ue.each(t, function(t, n) {
                      ue.isFunction(n)
                        ...
                        : n && n.length && "string" !== ue.type(n) && r(n);
                    });
                  })(arguments),
                  n && !t && l()),
                this
        ...
        ue.extend({
            ...
            return (
              ...
              ue.each(t, function(e, o) {
                ...
                (r[o[1]] = i.add),
                  ...
                  (a[o[0]] = function() {
                    return (
                      a[o[0] + "With"](this === a ? r : this, arguments), this
                    );
                  }),
          ...
          when: function(e) {
            var t,
              ...
              o = ee.call(arguments),
              i = o.length,
              s = 1 !== i || (e && ue.isFunction(e.promise)) ? i : 0,
              l = 1 === s ? e : ue.Deferred(),
              u = function(e, n, r) {
                return function(a) {
                  (n[e] = this),
                    (r[e] = arguments.length > 1 ? ee.call(arguments) : a),
                    r === t ? l.notifyWith(n, r) : --s || l.resolveWith(n, r);
                };
              };
            if (i > 1)
              for (
                t = new Array(i), n = new Array(i), r = new Array(i);
                i > a;
                a++
              )
                o[a] && ue.isFunction(o[a].promise)
                  ? o[a]
                      .promise()
                      .progress(u(a, n, t))
                      .done(u(a, r, o))
      ...
      (ue.fn.ready = function(e) {
        ...
        ue.extend({
          ...
          ready: function(e) {
            (e === !0 ? --ue.readyWait : ue.isReady) ||
              ((ue.isReady = !0),
              (e !== !0 && --ue.readyWait > 0) ||
                (Te.resolveWith(Q, [ue]),
                ue.fn.triggerHandler &&
                  (ue(Q).triggerHandler("ready"), ue(Q).off("ready"))));
          }
        }),
          ...
          return (
            Te ||
              ...
              ("loading" !== Q.readyState && !Q.documentElement.doScroll)
                ? n.setTimeout(ue.ready)
                : (Q.addEventListener("DOMContentLoaded", c),
      ...
      var Re = function(e, t, n, r, a, o, i) {
          ...
          if ("object" === ue.type(n)) {
            ...
            for (; l > s; s++) t(e[s], n, i ? r : r.call(e[s], s, t(e[s], n)));
        ...
        (p.prototype = {
          ...
          access: function(e, t, n) {
            ...
            return void 0 === t || (t && "string" == typeof t && void 0 === n)
              ? ((r = this.get(e, t)),
                void 0 !== r ? r : this.get(e, ue.camelCase(t)))
          ...
          remove: function(e, t) {
            ...
            if (void 0 !== o) {
              if (void 0 === t) this.register(e);
                ...
                ue.isArray(t)
                  ? (r = t.concat(t.map(ue.camelCase)))
                  : ((a = ue.camelCase(t)),
                    t in o
                      ? (r = [t, a])
                      : ((r = a), (r = r in o ? [r] : r.match(_e) || []))),
                  (n = r.length);
                for (; n--; ) delete o[r[n]];
              }
              (void 0 === t || ue.isEmptyObject(o)) &&
                (e.nodeType
              ...
              if (
                ...
                for (n = i.length; n--; )
                  i[n] &&
                    ((r = i[n].name),
                    0 === r.indexOf("data-") &&
                      ((r = ue.camelCase(r.slice(5))), d(o, r, a[r])));
                  ...
                  function(t) {
                    ...
                    if (o && void 0 === t) {
                      if (
                        ((n =
                          Ne.get(o, e) ||
                          Ne.get(o, e.replace(Ie, "-$&").toLowerCase())),
                        void 0 !== n)
                      )
                        return n;
                      if (
          ...
          queue: function(e, t, n) {
            ...
            return e
              ? ((t = (t || "fx") + "queue"),
                ...
                n &&
                  (!r || ue.isArray(n)
                    ? (r = Se.access(e, t, ue.makeArray(n)))
                    : r.push(n)),
                r || [])
              : void 0;
          },
      ...
      (ue.event = {
              ...
              n.handler && ((o = n), (n = o.handler), (a = o.selector)),
                ...
                (i = m.handle) ||
                  (i = m.handle = function(t) {
                    return "undefined" != typeof ue &&
                      ue.event.triggered !== t.type
                      ? ue.event.dispatch.apply(e, arguments)
                      : void 0;
                  }),
                t = (t || "").match(_e) || [""],
                u = t.length;
              ...
              (s = Ve.exec(t[u]) || []),
                ...
                f &&
                  ...
                  (d = l[f]) ||
                    ((d = l[f] = []),
                    (d.delegateCount = 0),
                    (p.setup && p.setup.call(e, r, h, i) !== !1) ||
        ...
        dispatch: function(e) {
          ...
          if (
            ...
            for (
              i = ue.event.handlers.call(this, e, l), t = 0;
              (a = i[t++]) && !e.isPropagationStopped();

            )
              for (
                e.currentTarget = a.elem, n = 0;
                (o = a.handlers[n++]) && !e.isImmediatePropagationStopped();
                ...
                (e.rnamespace && !e.rnamespace.test(o.namespace)) ||
                  ...
                  (e.data = o.data),
                  (r = (
                    (ue.event.special[o.origType] || {}).handle || o.handler
                  ).apply(a.elem, s)),
                  void 0 !== r &&
                    (e.result = r) === !1 &&
                ...
                for (r = [], n = 0; s > n; n++)
                  (o = t[n]),
                    ...
                    void 0 === r[a] &&
                      (r[a] = o.needsContext
                        ? ue(a, this).index(l) > -1
                        : ue.find(a, this, null, [l]).length),
                    r[a] && r.push(o);
                r.length && i.push({ elem: l, handlers: r });
              }
          return (
            s < t.length && i.push({ elem: this, handlers: t.slice(s) }), i
          );
        },
      ...
      ue.extend({
        ...
        clone: function(e, t, n) {
          ...
          if (
            ...
            for (i = h(s), o = h(e), r = 0, a = o.length; a > r; r++)
              _(o[r], i[r]);
          if (t)
            if (n)
              for (
                o = o || h(e), i = i || h(s), r = 0, a = o.length;
                a > r;
                r++
              )
                C(o[r], i[r]);
          ...
          return (
            (i = h(s, "script")), i.length > 0 && g(i, !l && h(e, "script")), s
          );
        },
        cleanData: function(e) {
          for (
            var t, n, r, a = ue.event.special, o = 0;
            void 0 !== (n = e[o]);
            o++
          )
            if (ke(n)) {
        ...
        ue.fn.extend({
          ...
          empty: function() {
            for (var e, t = 0; null != (e = this[t]); t++)
              1 === e.nodeType &&
                (ue.cleanData(h(e, !1)), (e.textContent = ""));
            return this;
          },
          clone: function(e, t) {
            return (
                ...
                if (
                  ...
                  try {
                    for (; r > n; n++)
                      (t = this[n] || {}),
                        1 === t.nodeType &&
                          (ue.cleanData(h(t, !1)), (t.innerHTML = e));
                    t = 0;
                  } catch (a) {}
                }
          ...
          replaceWith: function() {
            ...
            return T(
              ...
              function(t) {
                ...
                ue.inArray(this, e) < 0 &&
                  (ue.cleanData(h(this)), n && n.replaceChild(t, this));
              },
              e
            );
          }
        ...
        ue.each(
          ...
          function(e, t) {
            ue.fn[e] = function(e) {
              for (
                var n, r = [], a = ue(e), o = a.length - 1, i = 0;
                o >= i;
                i++
              )
      ...
      ue.extend({
        ...
        style: function(e, t, n, r) {
          if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
            var a,
              ...
              l = e.style;
            return (
              (t = ue.cssProps[s] || (ue.cssProps[s] = I(s) || s)),
              (i = ue.cssHooks[t] || ue.cssHooks[s]),
              void 0 === n
                ? i && "get" in i && void 0 !== (a = i.get(e, !1, r))
                  ? a
                  : l[t]
                : ((o = typeof n),
                  "string" === o &&
        ...
        css: function(e, t, n, r) {
          ...
          return (
            ...
            "" === n || n
              ? ((o = parseFloat(a)), n === !0 || isFinite(o) ? o || 0 : a)
              : a
          );
        }
      }),
        ue.each(["height", "width"], function(e, t) {
          ue.cssHooks[t] = {
            get: function(e, n, r) {
              return n
                ? rt.test(ue.css(e, "display")) && 0 === e.offsetWidth
                  ? tt(e, at, function() {
                      return D(e, t, r);
                    })
                  : D(e, t, r)
            ...
            set: function(e, n, r) {
              var a,
                ...
                i =
                  r &&
                  P(e, t, r, "border-box" === ue.css(e, "boxSizing", !1, o), o);
              return (
                i &&
                  (a = Pe.exec(n)) &&
                  "px" !== (a[3] || "px") &&
                  ((e.style[t] = n), (n = ue.css(e, t))),
                L(e, n, i)
              );
            }
          };
        ...
        (ue.cssHooks.marginRight = O(se.reliableMarginRight, function(e, t) {
          return t
            ? tt(e, { display: "inline-block" }, N, [e, "marginRight"])
            : void 0;
        })),
            ...
            return Re(
              ...
              function(e, t, n) {
                var r,
                  ...
                  i = 0;
                if (ue.isArray(t)) {
                  for (r = et(e), a = t.length; a > i; i++)
                    o[t[i]] = ue.css(e, t[i], !1, r);
                  return o;
                }
        ...
        (j.prototype = {
          ...
          init: function(e, t, n, r, a, o) {
            (this.elem = e),
              (this.prop = n),
              (this.easing = a || ue.easing._default),
              (this.options = t),
          ...
          run: function(e) {
            ...
            return (
              this.options.duration
                ? (this.pos = t = ue.easing[this.easing](
                    e,
          ...
          _default: {
            ...
            set: function(e) {
              ue.fx.step[e.prop]
                ? ue.fx.step[e.prop](e)
                : 1 !== e.elem.nodeType ||
                  (null == e.elem.style[ue.cssProps[e.prop]] &&
                    !ue.cssHooks[e.prop])
                ? (e.elem[e.prop] = e.now)
      ...
      (ue.Animation = ue.extend(W, {
        ...
        (ue.speed = function(e, t, n) {
          ...
          return (
            (r.duration = ue.fx.off
              ? 0
              : "number" == typeof r.duration
              ? r.duration
              : r.duration in ue.fx.speeds
              ? ue.fx.speeds[r.duration]
        ...
        ue.fn.extend({
          ...
          animate: function(e, t, n, r) {
            ...
            return (
              (i.finish = i),
              a || o.queue === !1 ? this.each(i) : this.queue(o.queue, i)
            );
          },
          stop: function(e, t, n) {
            var r = function(e) {
            ...
            if (3 !== o && 8 !== o && 2 !== o)
              return "undefined" == typeof e.getAttribute
                ...
                : ((1 === o && ue.isXMLDoc(e)) ||
                    ...
                    (a =
                      ue.attrHooks[t] ||
                      (ue.expr.match.bool.test(t) ? dt : void 0))),
                  void 0 !== n
                    ? null === n
                      ? void ue.removeAttr(e, t)
                      : a && "set" in a && void 0 !== (r = a.set(e, n, t))
                      ? r
                      : (e.setAttribute(t, n + ""), n)
                    : a && "get" in a && null !== (r = a.get(e, t))
                    ? r
                    : ((r = ue.find.attr(e, t)), null == r ? void 0 : r));
          },
          attrHooks: {
            type: {
              set: function(e, t) {
          ...
          ft[t] = function(e, t, r) {
            ...
            return (
              r ||
                ((o = ft[t]),
                (ft[t] = a),
                (a = null != n(e, t, r) ? t.toLowerCase() : null),
                (ft[t] = o)),
              a
            );
          };
        ...
        ue.extend({
          prop: function(e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o)
              return (
                (1 === o && ue.isXMLDoc(e)) ||
                  ((t = ue.propFix[t] || t), (a = ue.propHooks[t])),
                void 0 !== n
                  ? a && "set" in a && void 0 !== (r = a.set(e, n, t))
                    ? r
                    : (e[t] = n)
      ...
      ue.fn.extend({
              ...
              return (
                ...
                this.each(function(n) {
                  ...
                  1 === this.nodeType &&
                    ...
                    (t && "set" in t && void 0 !== t.set(this, a, "value")) ||
                      (this.value = a));
                })
              );
            if (a)
              return (
                (t =
                  ue.valHooks[a.type] || ue.valHooks[a.nodeName.toLowerCase()]),
        ...
        ue.extend({
          valHooks: {
            ...
            select: {
              ...
              set: function(e, t) {
                for (
                  var n, r, a = e.options, o = ue.makeArray(t), i = a.length;
                  i--;

                )
                  (r = a[i]),
                    (r.selected =
                      ue.inArray(ue.valHooks.option.get(r), o) > -1) &&
                      (n = !0);
        ...
        ue.each(["radio", "checkbox"], function() {
          (ue.valHooks[this] = {
            set: function(e, t) {
              return ue.isArray(t)
                ? (e.checked = ue.inArray(ue(e).val(), t) > -1)
                : void 0;
            }
          }),
            se.checkOn ||
      ...
      ue.extend(ue.event, {
        trigger: function(e, t, r, a) {
          ...
          if (
            ...
            3 !== r.nodeType &&
              8 !== r.nodeType &&
              !yt.test(f + ue.event.triggered) &&
              (f.indexOf(".") > -1 &&
                ((h = f.split(".")), (f = h.shift()), h.sort()),
              (u = f.indexOf(":") < 0 && "on" + f),
              (e = e[ue.expando]
                ? e
                : new ue.Event(f, "object" == typeof e && e)),
              (e.isTrigger = a ? 2 : 3),
              (e.namespace = h.join(".")),
              ...
              (p = ue.event.special[f] || {}),
              a || !p.trigger || p.trigger.apply(r, t) !== !1))
          ) {
            if (!a && !p.noBubble && !ue.isWindow(r)) {
              for (
                l = p.delegateType || f, yt.test(l + f) || (i = i.parentNode);
                i;
                i = i.parentNode
              )
                d.push(i), (s = i);
            ...
            for (o = 0; (i = d[o++]) && !e.isPropagationStopped(); )
              (e.type = o > 1 ? l : p.bindType || f),
                (c =
                  (Se.get(i, "events") || {})[e.type] && Se.get(i, "handle")),
                c && c.apply(i, t),
                (c = u && i[u]),
                c &&
                  c.apply &&
            ...
            return (
              ...
              a ||
                ...
                (p._default && p._default.apply(d.pop(), t) !== !1) ||
                !ke(r) ||
                (u &&
                  ue.isFunction(r[f]) &&
                  !ue.isWindow(r) &&
          ...
          ue.each({ focus: "focusin", blur: "focusout" }, function(e, t) {
            ...
            ue.event.special[t] = {
              ...
              teardown: function() {
                ...
                a
                  ? Se.access(r, t, a)
                  : (r.removeEventListener(e, n, !0), Se.remove(r, t));
              }
            };
          });
      var xt = n.location,
      ...
      (It.href = xt.href),
        ue.extend({
          ...
          ajax: function(e, t) {
                ...
                u
                  ? (d.ifModified &&
                    ...
                    204 === e || "HEAD" === d.type
                      ...
                      : 304 === e
                      ? (E = "notmodified")
                      : ((E = y.state), (p = y.data), (v = y.error), (u = !v)))
                  : ((v = E), (!e && E) || ((E = "error"), 0 > e && (e = 0))),
                (A.status = e),
                (A.statusText = (t || E) + ""),
                u ? g.resolveWith(f, [p, E, A]) : g.rejectWith(f, [A, E, v]),
                A.statusCode(b),
                (b = void 0),
                c &&
                  h.trigger(u ? "ajaxSuccess" : "ajaxError", [A, d, u ? p : v]),
                m.fireWith(f, [A, E]),
                c &&
                  (h.trigger("ajaxComplete", [A, d]),
            ...
            if (
              ((g.promise(A).complete = m.add),
              (A.success = A.done),
              (A.error = A.fail),
              (d.url = ((e || d.url || xt.href) + "")
                .replace(Et, "")
                .replace(kt, xt.protocol + "//")),
            ...
            if (
              (d.data &&
                ...
                (d.data = ue.param(d.data, d.traditional)),
              Y(St, d, t, A),
              2 === x)
            )
              return A;
            (c = ue.event && d.global),
              ...
              d.ifModified &&
                (ue.lastModified[o] &&
                  A.setRequestHeader("If-Modified-Since", ue.lastModified[o]),
                ue.etag[o] && A.setRequestHeader("If-None-Match", ue.etag[o])),
              ...
              A.setRequestHeader(
                ...
                d.dataTypes[0] && d.accepts[d.dataTypes[0]]
                  ? d.accepts[d.dataTypes[0]] +
                      ("*" !== d.dataTypes[0] ? ", " + Ot + "; q=0.01" : "")
                  : d.accepts["*"]
              );
            for (p in d.headers) A.setRequestHeader(p, d.headers[p]);
            if (d.beforeSend && (d.beforeSend.call(f, A, d) === !1 || 2 === x))
              return A.abort();
            w = "abort";
            for (p in { success: 1, error: 1, complete: 1 }) A[p](d[p]);
            if ((a = Y(Nt, d, t, A))) {
              if (
                ((A.readyState = 1),
                c && h.trigger("ajaxSend", [A, d]),
                2 === x)
              )
                return A;
              d.async &&
        ...
        ue.each(["get", "post"], function(e, t) {
          ue[t] = function(e, n, r, a) {
            return (
              ue.isFunction(n) && ((a = a || r), (r = n), (n = void 0)),
              ue.ajax(
                ue.extend(
      ...
      (ue.param = function(e, t) {
        ...
        if (
          (void 0 === t && (t = ue.ajaxSettings && ue.ajaxSettings.traditional),
      ...
      ue.ajaxSetup({
        ...
        ue.ajaxPrefilter("json jsonp", function(e, t, r) {
          ...
          return s || "jsonp" === e.dataTypes[0]
            ? ((a = e.jsonpCallback = ue.isFunction(e.jsonpCallback)
                ? e.jsonpCallback()
                : e.jsonpCallback),
              s
                ? (e[s] = e[s].replace(Bt, "$1" + a))
                : e.jsonp !== !1 &&
                  (e.url += (At.test(e.url) ? "&" : "?") + e.jsonp + "=" + a),
              ...
              r.always(function() {
                void 0 === o ? ue(n).removeProp(a) : (n[a] = o),
                  e[a] && ((e.jsonpCallback = t.jsonpCallback), Ft.push(a)),
                  i && ue.isFunction(o) && o(i[0]),
                  (i = o = void 0);
              }),
              "script")
            : void 0;
      ...
      (ue.fn.load = function(e, t, n) {
        ...
        var r,
          ...
          s = e.indexOf(" ");
        return (
          s > -1 && ((r = ue.trim(e.slice(s))), (e = e.slice(0, s))),
          ue.isFunction(t)
            ? ((n = t), (t = void 0))
          ...
          setOffset: function(e, t, n) {
            ...
            "static" === c && (e.style.position = "relative"),
              ...
              (u =
                ...
                (o + l).indexOf("auto") > -1),
              u
                ? ((r = p.position()), (i = r.top), (a = r.left))
                : ((i = parseFloat(o) || 0), (a = parseFloat(l) || 0)),
              ue.isFunction(t) && (t = t.call(e, n, ue.extend({}, s))),
        ...
        ue.each(["top", "left"], function(e, t) {
          ue.cssHooks[t] = O(se.pixelPosition, function(e, n) {
            return n
              ? ((n = N(e, t)), Qe.test(n) ? ue(e).position()[t] + "px" : n)
              : void 0;
          });
        }),
      ...
      var Wt = n.jQuery,
        Vt = n.$;
      return (
        (ue.noConflict = function(e) {
          return (
            n.$ === ue && (n.$ = Vt),
            e && n.jQuery === ue && (n.jQuery = Wt),
            ue
          );
        }),
        o || (n.jQuery = n.$ = ue),
        ...
        var t = "tota11y-annotation-" + e,
          ...
          i = function(e, a) {
            var o = r("<div>")
              ...
              .css(e.position())
              .data({ $el: e });
            return n.push({ $annotation: o, $parent: e.offsetParent() }), o;
          },
          s = 20;
        return (
          (function l() {
          ...
          }),
          {
            ...
            errorLabel: function(e, t, n, o) {
              var i = r(a({ text: t, detail: n, hasErrorEntry: !!o }));
              return (
                o &&
                  (i.find(".tota11y-label-link").click(function(e) {
  ...
  function(e, t) {
    ...
    function n(e, t) {
      var a = t && t.loc,
        ...
        i = void 0;
      a &&
        ((o = a.start.line), (i = a.start.column), (e += " - " + o + ":" + i));
      for (
      ...
      Error.captureStackTrace && Error.captureStackTrace(this, n),
        a && ((this.lineNumber = o), (this.column = i));
    }
    t.__esModule = !0;
    var r = [
      "description",
  ...
  function(e, t) {
    ...
    function r(e) {
      ...
      return (
        (t.showUnsupportedRulesWarning = !1),
        t.ignoreSelectors(e, ".tota11y *"),
    ...
    function a() {
      axs.AuditRule.collectMatchingElements = function(e, t, n, r) {
        ...
        if (a && "content" == a.localName)
          for (var i = a, s = i.getDistributedNodes(), l = 0; l < s.length; l++)
            axs.AuditRule.collectMatchingElements(s[l], t, n, r);
        else {
          if (a && "shadow" == a.localName) {
            var u = a;
            if (r)
              for (var s = u.getDistributedNodes(), l = 0; l < s.length; l++)
                axs.AuditRule.collectMatchingElements(s[l], t, n, r);
            else console.warn("ShadowRoot not provided for", a);
          }
          for (var c = e.firstChild; null != c; )
            axs.AuditRule.collectMatchingElements(c, t, n, r),
              (c = c.nextSibling);
        }
      };
    }
    function o(e) {
      ...
      return (
        a(),
        axs.Audit.run(t).filter(function(t) {
    ...
    function a(e) {
      e.registerHelper("helperMissing", function() {
        ...
        e.registerHelper("blockHelperMissing", function(t, n) {
          ...
          if (n.data && n.ids) {
            var i = o(n.data);
            (i.contextPath = l.appendContextPath(n.data.contextPath, n.name)),
              (n = { data: i });
          }
          return a(t, n);
        }),
        e.registerHelper("each", function(e, t) {
          function n(t, n, a) {
            u &&
              ...
              (s += r(e[t], {
                data: u,
                blockParams: l.blockParams([e[t], t], [p + t, null])
              }));
          }
          ...
          if (
            (t.data &&
              t.ids &&
              (p = l.appendContextPath(t.data.contextPath, t.ids[0]) + "."),
            g(e) && (e = e.call(this)),
            t.data && (u = o(t.data)),
            e && "object" == typeof e)
          )
            if (h(e))
              for (var d = e.length; d > i; i++) n(i, i, i === e.length - 1);
            else {
              var f = void 0;
              for (var m in e)
        ...
        e.registerHelper("with", function(e, t) {
          ...
          if (t.data && t.ids) {
            var r = o(t.data);
            (r.contextPath = l.appendContextPath(t.data.contextPath, t.ids[0])),
              (t = { data: r });
          }
          return n(e, t);
        }),
        e.registerHelper("log", function(t, n) {
          var r =
            n.data && null != n.data.level ? parseInt(n.data.level, 10) : 1;
          e.log(r, t);
        }),
          ...
          o(n, [
            ...
            },
            {
              ...
              value: function() {
                this.summary(" "),
                  this.panel.render(),
                  s(document).on("mousemove.wand", function(e) {
                    var n = document.elementFromPoint(e.clientX, e.clientY),
                      r = axs.properties.findTextAlternatives(n, {});
                    s(".tota11y-outlined").removeClass("tota11y-outlined"),
                      s(n).addClass("tota11y-outlined"),
                      r
                        ? s(".tota11y-info-section.active").text(r)
                        : s(".tota11y-info-section.active").html(
                            t(
                              "i",
                    ...
                    o = t(
                      ...
                      t(
                        ...
                        t(
                          "code",
                          null,
                          '&lt;img src="' + r + '" alt="Image description"&gt'
                        )
                      ),
                      t(
                        "p",
              ...
              },
              {
                ...
                value: function() {
                  var e = c("imagesWithoutAltText"),
                    t = e.result,
                    n = e.elements;
                  "FAIL" === t && n.forEach(this.reportError.bind(this)),
                    s('img[role="presentation"], img[alt=""]').each(function(
                      e,
                      t
                    ) {
                      u.errorLabel(
        ...
        o(t, [
          ...
          },
          {
            ...
            value: function(e, t) {
              var n = e.style,
                ...
                h = n.backgroundColor;
              return (
                d.find(".preview-contrast-fix").click(function(e) {
                  s(e.target).prop("checked")
                    ? (s(t).css("color", l.fg),
                      s(t).css("background-color", l.bg))
                    : (s(t).css("color", f), s(t).css("background-color", h));
                }),
          ...
          },
          {
            ...
            value: function() {
              ...
              s("*").each(function(n, r) {
                if (
                  axs.properties.hasDirectTextDescendant(r) &&
                  !(
                    s(r).parents(".tota11y").length > 0 ||
                    axs.utils.elementIsTransparent(r) ||
                    axs.utils.elementHasZeroArea(r)
                  )
                ) {
                  var a = getComputedStyle(r),
                    ...
                    p =
                      axs.color.colorToString(i) +
                      "/" +
                      axs.color.colorToString(o) +
                      "/" +
                      c;
                  if (axs.utils.isLowContrast(l, a)) {
                    ...
                    t[p] ||
                      (u.label(s(r), l).addClass("tota11y-label-success"),
                      (t[p] = !0));
                }
              });
            }
  ...
  function(e, t, n) {
    (function(t) {
      ...
      var p = {
          ...
          MULTIPLE_H1: { title: "&lt;h1&gt; used when one is already present" },
          NONCONSECUTIVE_HEADER: function(e, t) {
            ...
            return (
              ...
              {
                title:
                  "\n                Nonconsecutive heading level used (h" +
                  e +
                  " &rarr;\n                h" +
                  t +
                  ")\n            ",
                ...
                value: function(e) {
                  ...
                  return (
                    e.each(function(e, a) {
                      ...
                      0 === e && 1 !== i
                        ? (l = p.FIRST_NOT_H1(i))
                        : r && i - r > 1 && (l = p.NONCONSECUTIVE_HEADER(r, i)),
                        (r = i);
                      var d = s(c({ level: i, text: o.text() }));
  ...
  function(e, t, n) {
    ...
    var r = n(14),
      ...
      u = n(13);
    e.exports = {
      default: [new o(), new a(), new l(), new i(), new r(), new s()],
      experimental: [new u()]
    };
  },
  function(e, t, n) {
                ...
                "FAIL" === n &&
                  r.forEach(function(t) {
                    var n = s(t),
                      ...
                      a = e.error(r, s(e.errorMessage(n)), n);
                    u.errorLabel(n, "", r, a);
                  });
              }
            },
        ...
        return (
          ...
          o(t, [
            ...
            },
            {
              key: "run",
              value: function() {
                s("[role]:not(.tota11y-toolbar,.tota11y-plugin)").each(
                  function() {
            ...
            o(n, [
              ...
              },
              {
                ...
                value: function(e) {
                  ...
                  return (
                    (e = e.replace(/[^a-zA-Z ]/g, "").replace(n, "")),
                    "" !== e.trim()
                  );
                }
              },
              ...
              },
              {
                ...
                value: function() {
                  ...
                  s("a").each(function(n, r) {
                    var a = s(r);
                    if (
                      !a.parents(".tota11y").length &&
                      !axs.utils.isElementOrAncestorHidden(r)
                    ) {
                      var o = {},
                        i = axs.properties.findTextAlternatives(r, o);
          ...
          return (
            a(e, [
              ...
              },
              {
                key: "addError",
                value: function(e, t, n) {
                  var r = { title: e, $description: t, $el: n };
              ...
              },
              {
                ...
                value: function(e, n) {
                  ...
                  var i = o("<div>")
                    ...
                    .html(n);
                  return (
                    this.$el.find(".tota11y-info-sections").append(i),
                    a.on("activate", function() {
                      r.$el
                        .find(".tota11y-info-tab.active")
                        .removeClass("active"),
                        r.$el
                          .find(".tota11y-info-section.active")
                          .removeClass("active"),
                        a.addClass("active"),
                        i.addClass("active");
                    }),
              ...
              },
              {
                ...
                value: function() {
                  var e = this,
                    ...
                    n = void 0;
                  this.$el
                    .find(".tota11y-info-dismiss-trigger")
                    .click(function(t) {
                      t.preventDefault(),
                        t.stopPropagation(),
                        e.$el.addClass(c),
                        e.plugin.$checkbox.focus();
                    }),
                    o("body").append(this.$el),
                    (t = window.innerWidth - this.$el.width() - l),
                    (n = window.innerHeight - this.$el.height() - l);
                  var r = this.$el.find(".tota11y-info-title"),
                    a = !1,
                    i = void 0,
                    s = void 0,
                    u = void 0,
                ...
                value: function() {
                  ...
                  this.$el = t(
                    ...
                    t(
                      ...
                      t("div", { className: "tota11y-info-sections" }),
                      t("ul", {
                        role: "tablist",
                  ...
                  var r = void 0;
                  return (
                    this.about && (r = this._addTab("About", this.about)),
                    this.summary && (r = this._addTab("Summary", this.summary)),
                      ...
                      !(function() {
                        ...
                        e.errors.forEach(function(r, a) {
                          ...
                          l
                            ...
                            .prepend(r.$description),
                            t.append(l);
                          var p = l.find(".tota11y-info-error-trigger"),
                            d = l.find(".tota11y-info-error-description");
                          p.click(function(e) {
                            e.preventDefault(),
                              e.stopPropagation(),
                              p.toggleClass(u),
                          ...
                          f.click(function(e) {
                            e.preventDefault(),
                              e.stopPropagation(),
                              o(document).scrollTop(r.$el.offset().top - 80);
                          }),
                            0 === a && (d.toggleClass(u), p.toggleClass(u)),
                            i.toggleHighlight(r.$el, p),
                            i.toggleHighlight(r.$el, f);
                    ...
                    r && (r.trigger("activate"), (n = !0)),
                    n && this.initAndPosition(),
                    this.$el.focus(),
                    this.$el
                  );
                }
    ...
    e.exports = (r["default"] || r).template({
      ...
      main: function(e, t, n, r) {
        ...
        return (
          ...
          s(
            ((a =
              null != (a = t.fgColorHex || (null != e ? e.fgColorHex : e))
                ? a
                : o),
            typeof a === i
              ? a.call(e, { name: "fgColorHex", hash: {}, data: r })
              : a)
          ) +
          "/" +
          s(
            ((a =
              null != (a = t.bgColorHex || (null != e ? e.bgColorHex : e))
                ? a
                : o),
            typeof a === i
              ? a.call(e, { name: "bgColorHex", hash: {}, data: r })
              : a)
          ) +
          "</span>\n        has a contrast ratio of <strong>" +
          s(
            ((a =
              null != (a = t.contrastRatio || (null != e ? e.contrastRatio : e))
                ? a
                : o),
            typeof a === i
              ? a.call(e, { name: "contrastRatio", hash: {}, data: r })
              : a)
          ) +
          "</strong>, which is not\n        sufficient. At this size, you will need a ratio of at least\n        <strong>" +
          s(
            ((a =
              null != (a = t.requiredRatio || (null != e ? e.requiredRatio : e))
                ? a
                : o),
            typeof a === i
              ? a.call(e, { name: "requiredRatio", hash: {}, data: r })
              : a)
          ) +
          ...
          s(
            ((a =
              null !=
              (a =
                t.suggestedFgColorHex ||
                (null != e ? e.suggestedFgColorHex : e))
                ? a
                : o),
            typeof a === i
              ? a.call(e, { name: "suggestedFgColorHex", hash: {}, data: r })
              : a)
          ) +
          "/" +
          s(
            ((a =
              null !=
              (a =
                t.suggestedBgColorHex ||
                (null != e ? e.suggestedBgColorHex : e))
                ? a
                : o),
            typeof a === i
              ? a.call(e, { name: "suggestedBgColorHex", hash: {}, data: r })
              : a)
          ) +
          ...
          s(
            ((a =
              null !=
              (a =
                t.suggestedColorsRatio ||
                (null != e ? e.suggestedColorsRatio : e))
                ? a
                : o),
            typeof a === i
              ? a.call(e, { name: "suggestedColorsRatio", hash: {}, data: r })
              : a)
          ) +
    ...
    e.exports = (r["default"] || r).template({
      ...
      main: function(e, t, n, r) {
        var a,
          ...
          s = this.escapeExpression;
        return (
          '<div class="tota11y-heading-outline-entry heading-level-' +
          s(
            ((a = null != (a = t.level || (null != e ? e.level : e)) ? a : o),
            typeof a === i
              ? a.call(e, { name: "level", hash: {}, data: r })
              : a)
          ) +
          ...
          s(
            ((a = null != (a = t.text || (null != e ? e.text : e)) ? a : o),
            typeof a === i ? a.call(e, { name: "text", hash: {}, data: r }) : a)
          ) +
          "</span>\n</div>\n"
        );
      },
    ...
    e.exports = (r["default"] || r).template({
      ...
      3: function(e, t, n, r) {
        ...
        return (
          ...
          this.escapeExpression(
            ((a =
              null != (a = t.id || (null != e ? e.id : e))
                ? a
                : t.helperMissing),
            "function" == typeof a
              ? a.call(e, { name: "id", hash: {}, data: r })
              : a)
          ) +
          '"&gt;\n    Label text here...\n&lt;/label&gt;</code></pre>\n'
        );
      ...
      5: function(e, t, n, r) {
        ...
        return (
          ...
          this.escapeExpression(
            ((a =
              null != (a = t.tagName || (null != e ? e.tagName : e))
                ? a
                : t.helperMissing),
            "function" == typeof a
              ? a.call(e, { name: "tagName", hash: {}, data: r })
              : a)
          ) +
      ...
      main: function(e, t, n, r) {
        ...
        return (
          (null !=
          (a = t["if"].call(e, null != e ? e.placeholder : e, {
            name: "if",
            hash: {},
    ...
    e.exports = (r["default"] || r).template({
      ...
      main: function(e, t, n, r) {
        ...
        return (
          ...
          (null !=
          ((o = null != (o = t.detail || (null != e ? e.detail : e)) ? o : i),
          (a =
            typeof o === s
              ? o.call(e, { name: "detail", hash: {}, data: r })
              : o))
            ? a
            : "") +
          "</div>\n</span>\n"
    ...
    e.exports = (r["default"] || r).template({
      ...
      main: function(e, t, n, r) {
        ...
        return (
          ...
          (null !=
          ((o =
            null != (o = t.title || (null != e ? e.title : e))
              ? o
              : t.helperMissing),
          (a =
            "function" == typeof o
              ? o.call(e, { name: "title", hash: {}, data: r })
              : o))
            ? a
            : "") +
  ...
  function(e, t, n) {
    ...
    function a(e, t) {
      ...
      function r(t) {
        ...
        return (
          e.useDepths && (i = n.depths ? [t].concat(n.depths) : [t]),
      ...
      var a = {
        ...
        program: function(e, t, n, r, a) {
          ...
          return (
            t || a || r || n
              ? (i = o(this, e, s, t, n, r, a))
              : i || (i = this.programs[e] = o(this, e, s)),
            i
          );
        },
        data: function(e, t) {
      ...
      return (
        ...
        (r._setup = function(n) {
          n.partial
            ? ((a.helpers = n.helpers), (a.partials = n.partials))
    ...
    function u(e, t) {
      return (
        (t && "root" in t) || ((t = t ? g.createFrame(t) : {}), (t.root = e)), t
      );
    }
    var c = function(e) {
      return e && e.__esModule ? e : { default: e };
